...
<head>
    ...
    <style>
        ...
        .nutriscore .highlight {
            border-color: black;
        }
        .nutriscore .A { background-color: #00b050; }
        .nutriscore .B { background-color: #92d050; }
        .nutriscore .C { background-color: #ffff00; }
        .nutriscore .D { background-color: #ff9900; }
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <div class="card-header">
                        <h5 class="card-title border-bottom">Barcode: {{ $productData['id'] }}</h5>
                        <div class="">
                            {!! DNS1D::getBarcodeHTML($productData['barcode'], 'C128') !!}
                        </div>
                        ...
                        <div class="nutriscore mb-3">
                            <h5 class="card-title text-start">Nutriscore</h5>
                            <div class="{{ $productData['nutriscore_grade'] }} {{ $productData['nutriscore_grade'] == 'a' ? 'highlight' : '' }}">A</div>
                            <div class="{{ $productData['nutriscore_grade'] }} {{ $productData['nutriscore_grade'] == 'b' ? 'highlight' : '' }}">B</div>
                            <div class="{{ $productData['nutriscore_grade'] }} {{ $productData['nutriscore_grade'] == 'c' ? 'highlight' : '' }}">C</div>
                            <div class="{{ $productData['nutriscore_grade'] }} {{ $productData['nutriscore_grade'] == 'd' ? 'highlight' : '' }}">D</div>
                            <div class="{{ $productData['nutriscore_grade'] }} {{ $productData['nutriscore_grade'] == 'e' ? 'highlight' : '' }}">E</div>
                        </div>
                    </div>
                </div>
                <div class="col-md-8">
